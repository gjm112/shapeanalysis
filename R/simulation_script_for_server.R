...
start_all <- Sys.time()
source("/home/gmatthews1/shapeAnalysis/R/utility.R")
source("/home/gmatthews1/shapeAnalysis/R/calc_shape_dist_partial.R")
source("/home/gmatthews1/shapeAnalysis/R/complete_partial_shape.R")
source("/home/gmatthews1/shapeAnalysis/R/impute_partial_shape.R")
source("/home/gmatthews1/shapeAnalysis/R/tooth_cutting.R")

library(fdasrvf)
library(parallel)
load("/home/gmatthews1/shapeAnalysis/data/data_set_of_full_teeth.RData")
load("/home/gmatthews1/shapeAnalysis/data/ptsTrainList.RData")
...
results_list <- list()
for (i in 1:length(ptsTrainList[["LM1"]])){
  print(i)
  print(Sys.time())
  ...
  ref_file <- read.csv("/home/gmatthews1/shapeAnalysis/data/refFile.csv")
  ...
  start <- Sys.time()
  dist_list <- mclapply(imputed_partial_shape[[1]],dist_imputed_to_whole2, mc.cores = 12)
  end <- Sys.time()
  end-start
