...
# nohup R CMD BATCH --vanilla /home/gmatthews1/Work/shapeanalysis/R/simulation_script_for_server_LM1_side1_20200706_k5_M5scaled.R /home/gmatthews1/Work/shapeanalysis/R/simulation_script_for_server_LM1_side1_20200706_k5_M5scaled.Rout &
...
#   beta1 = beta1 - repmat(centroid1, 1, T1)
  ...
  end_all <- Sys.time()
  end_all-start_all
  if (scale){outfile <- paste0("./results/results20200706_side=",side,"_k=",k,"_M=",M,"_tooth=",tooth,"scaled.RData")}
  if (!scale){outfile <- paste0("./results/results20200706_side=",side,"_k=",k,"_M=",M,"_tooth=",tooth,".RData")}
  save.image(outfile)
}
